...
export type AppearanceCalibrationGroup = Record<string, number>;
export interface AppearanceCalibration {
  careers: AppearanceCalibrationGroup;
  classes: AppearanceCalibrationGroup;
  powers: AppearanceCalibrationGroup;
  weaknesses: AppearanceCalibrationGroup;
  abilities: AppearanceCalibrationGroup;
  workStyles: AppearanceCalibrationGroup;
  animals: AppearanceCalibrationGroup;
  alignments: AppearanceCalibrationGroup;
}
